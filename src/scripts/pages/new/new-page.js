      ...
      <section class="container">
        <div class="new-form__container">
          <form id="new-form" class="new-form">
            <h1 class="new-form__title">Buat Ceritamu Sekarang</h1>
            <div class="form-control">
              <label for="description-input" class="new-form__description__title">Bagikan Kisah dan Pengalaman Unikmu</label>

              <div class="new-form__description__container">
                <textarea
                  id="description-input"
                  name="description"
                  placeholder="Ceritakan kisah dan pengalam unik atau hal lain yang ingin kamu bagikan kepada dunia."
                ></textarea>
              </div>
            </div>
            <div class="form-control">
              <label for="documentations-input" class="new-form__documentations__title">Tambahkan Gambar</label>
              <div id="documentations-more-info">Kamu dapat menambahkan gambar atau foto yang dapat mengespresikan ceritamu.</div>
            ...
            <div class="form-control">
              <div class="new-form__location__title">Tambahkan lokasimu.</div>
            ...
            <div class="form-buttons">
              <span id="submit-button-container">
                <button class="btn" type="submit">Kirimkan</button>
              </span>
              <a class="btn btn-outline" href="#/">Batalkan</a>
            </div>
          </form>
        </div>
      </section>
